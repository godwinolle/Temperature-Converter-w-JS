//done for the day, need to work on having the other options work
//add regex functionality with message saying not a number
...
const celcToKelv = (temp) => temp + 273.15;
